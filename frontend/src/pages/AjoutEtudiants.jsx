...
async function SubmitFormAjout() {
    ...
    fetchWraper.url = "https://10.1.1.44:5001/auth/ajout_etudiants";
...
async function getFieldsDataUtilisateurs(role) {
    let fetchWraper = new FetchWraper();
    fetchWraper.url = "https://10.1.1.44:5001/auth/get_users/" + role;
...
async function getFieldsInfo(nom) {
    let fetchWraper = new FetchWraper();
    fetchWraper.url = "https://10.1.1.44:5001/auth/get_info/" + nom;
    fetchWraper.method = "GET";
    fetchWraper.headers.append("Content-Type", "application/json");
    fetchWraper.headers.append("Accept", "application/json");
    fetchWraper.headers.append("Access-Control-Allow-Origin", "*");
